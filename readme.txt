...
1. Upload the plugin files to the `/wp-content/plugins/wp-ai-ready-plugin-boilerplate` directory, or install through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress.
3. Access the plugin settings under the WordPress admin menu.
4. Full developer documentation and human-readable source code: https://github.com/wordpress-ai/wp-ai-ready-plugin-boilerplate
...
= Is it compatible with WordPress 7.1+? =

Yes, it requires WordPress 7.1 or greater and is designed for modern WordPress versions and block editors.
