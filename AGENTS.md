...
6. **Mandatory Local Quality Gate & Autonomous Self-Healing Loop:**
   ...
   - **Autonomous Self-Healing Loop:** If any check fails, the agent MUST NOT stop or ask the user to fix errors. Parse the output, repair code, types, or tests locally, and rerun until all 6 checks are 100% green. Follow `.cursor/rules/local-quality-gate.mdc`.
