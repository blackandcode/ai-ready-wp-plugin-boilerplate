...
- **OpenAPI Schema:** Definition of request and response structures in controller.

## 4. UI / UX Components

- **Components:** WPDS primitives used (`CardLayout`, `Button`, `NoticeBanner`, `@wordpress/icons`).
