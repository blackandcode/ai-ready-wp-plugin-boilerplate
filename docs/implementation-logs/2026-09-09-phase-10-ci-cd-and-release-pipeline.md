...
- **Status:** Completed
- **Version Status:** Staged under `## [Unreleased]` in `CHANGELOG.md` (Version `1.1.1`; manual bump via `npm run update-version:minor` or `npm run update-version:patch` when ready)
