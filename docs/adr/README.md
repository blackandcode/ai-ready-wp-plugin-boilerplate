...
| [ADR-0015](0015-modular-scaffolding-pipeline-repository-history-reset-and-version-baseline.md) | Modular Scaffolding Pipeline, Repository History Reset, and Version Baseline | Accepted | 2026-09-14 | Amends [ADR-0006](0006-automated-project-scaffolding-cli.md) |
