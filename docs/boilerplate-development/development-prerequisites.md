...
2. **Configure Docker Desktop:**
   ...
   - Under Settings > Resources > WSL Integration > enable Ubuntu.
...
1. **Install Docker Engine & Compose plugin:**
   Follow official Docker instructions for Ubuntu/Debian (`docker-ce`, `docker-compose-plugin`).
2. **Install Node 24:**
   Via NodeSource or nvm.
3. **Install PHP 8.3 CLI & Composer:**
   Via `ppa:ondrej/php` (Ubuntu) or system packages.
