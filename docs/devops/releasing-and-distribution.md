...
# Apply version increment (e.g. 1.1.0 -> 1.1.0)
npm run update-version -- minor
```

This synchronizes `package.json`, `package-lock.json`, `composer.json`, main plugin header `Version:`, `AIRWP_VERSION` constant, `readme.txt` `Stable tag:`, and converts staged `## [Unreleased]` bullets into `## [1.1.0] - YYYY-MM-DD`.
...
3. Click **Run workflow**:
   - Branch: `main`
   - Target version: `1.1.0` (must match `package.json` exactly)
