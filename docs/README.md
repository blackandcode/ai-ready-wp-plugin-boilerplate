...
npm run update-version:minor    # e.g. 1.0.0 -> 1.4.0 (new features & phase completions)
...
npm run update-version -- 1.4.0 -m "Release highlights" -d "Approved v1.4.0 release"
