...
npm run update-version:minor    # e.g. 1.0.0 -> 1.1.0 (new features & phase completions)
...
- [Phased Execution and Agent Workflow Guide](specifications/phased-workflow-guide.md): Vertical slice decomposition, 4-document phase anatomy, pre/post-implementation logging, and acceptance verification gates.
...
- **[Phased Plans](plans/README.md):** Backward-compatible pointer to `docs/specifications/plans/`.
