...
npm run update-version:minor    # e.g. 1.0.0 -> 1.3.3 (new features & phase completions)
...
npm run update-version -- 1.3.3 -m "Release highlights" -d "Approved v1.3.3 release"
