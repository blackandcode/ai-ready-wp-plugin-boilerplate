...
export function GeneralSection( { settings, onChange }: GeneralSectionProps ) {
  return (
    <>
      <TextControl
        label={ __( 'Greeting Message', 'ai-ready-wp-plugin-boilerplate' ) }
      ...
      <ToggleControl
        label={ __( 'Enable Boilerplate Features', 'ai-ready-wp-plugin-boilerplate' ) }
      ...
      <TextareaControl
        label={ __( 'Plugin Description & Context', 'ai-ready-wp-plugin-boilerplate' ) }
