 ...
 * Diagnostics DTO.
 *
 * @package AIReady\WPPluginBoilerplate\Diagnostics\Application\DTO
 */

namespace AIReady\WPPluginBoilerplate\Diagnostics\Application\DTO;
...
readonly class DiagnosticsDTO {
	 ...
	 * @param string $rest_status REST status.
