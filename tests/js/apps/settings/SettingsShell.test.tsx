...
describe('SettingsShell Component', () => {
  it('renders general settings by default', () => {
    ...
    expect(screen.getByDisplayValue('Hello Unit Test')).toBeInTheDocument();
  ...
  it('navigates to advanced settings when tab clicked', () => {
    ...
    const advancedTab = screen.getByRole('button', { name: /Advanced & Retention/i });
    fireEvent.click(advancedTab);

    expect(screen.getByText(/REST API Debug Headers/i)).toBeInTheDocument();
  });
