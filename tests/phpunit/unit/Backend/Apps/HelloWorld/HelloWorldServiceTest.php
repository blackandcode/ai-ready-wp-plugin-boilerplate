 ...
 *
 * @package WPAIBP\Tests\Unit\Backend\Apps\HelloWorld
 */

namespace WPAIBP\Tests\Unit\Backend\Apps\HelloWorld;
...
class HelloWorldServiceTest extends TestCase {
	...
	public function test_greeting_value_object(): void {
		...
		$this->assertSame( 'Hello from WP AI Ready Plugin Boilerplate!', $default->value() );
	...
	public function test_service_returns_dto(): void {
		...
		$this->assertSame( 'Hello from WP AI Ready Plugin Boilerplate!', $dto->message );
